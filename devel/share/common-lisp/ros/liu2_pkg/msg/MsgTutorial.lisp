...
(cl:defmethod cl:initialize-instance :after ((m <MsgTutorial>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgTutorial)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name liu2_pkg-msg:<MsgTutorial> is deprecated: use liu2_pkg-msg:MsgTutorial instead.")))

(cl:ensure-generic-function 'stamp-val :lambda-list '(m))
(cl:defmethod stamp-val ((m <MsgTutorial>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader liu2_pkg-msg:stamp-val is deprecated.  Use liu2_pkg-msg:stamp instead.")
  (stamp m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <MsgTutorial>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader liu2_pkg-msg:data-val is deprecated.  Use liu2_pkg-msg:data instead.")
  (data m))
